...
public class OpenUrlHandler extends AbstractHandler {
     ...
     * INTERNAL BROWSER ID.
     */
    private static final String CONST_INTERNAL_BROWSER_ID = "AGSNBrowser"; //$NON-NLS-1$

    /**
     * INTERNAL BROWSER NAME.
     */
    private static final String CONST_INTERNAL_BROWSER_NAME = "AGSN External File";
    ...
    private static final String CONST_URL_ATTRIBUTE_NAME
            = "AGSN.diagram.custom.command.OpenUrl.parameter.Attribute"; //$NON-NLS-1$
    ...
    private String getAttachment(EObject eObj) {
        ...
        if (eObj instanceof Evidence) {
            Evidence evidence = (Evidence) eObj;
            return evidence.getAttachment();
        } else {
