...
import AGSN.util.AGSNValidator;
 ...
 * @generated
 */
public class AGSNPackageImpl extends EPackageImpl implements AGSNPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see AGSN.AGSNPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AGSNPackageImpl() {
		super(eNS_URI, AGSNFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AGSNPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AGSNPackage init() {
		if (isInited) return (AGSNPackage)EPackage.Registry.INSTANCE.getEPackage(AGSNPackage.eNS_URI);

		// Obtain or create and register package
		AGSNPackageImpl theAGSNPackage = (AGSNPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AGSNPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AGSNPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theAGSNPackage.createPackageContents();

		// Initialize created meta-data
		theAGSNPackage.initializePackageContents();
			...
			(theAGSNPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return AGSNValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theAGSNPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AGSNPackage.eNS_URI, theAGSNPackage);
		return theAGSNPackage;
	}
	 ...
	 * @generated
	 */
	public AGSNFactory getAGSNFactory() {
		return (AGSNFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGoal_Undeveloped(), ecorePackage.getEBoolean(), "undeveloped", "false", 0, 1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(strategyEClass, Strategy.class, "Strategy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStrategy_Undeveloped(), ecorePackage.getEBoolean(), "undeveloped", "false", 0, 1, Strategy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
