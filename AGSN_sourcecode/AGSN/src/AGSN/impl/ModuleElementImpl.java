 ...
 * </p>
 * <ul>
 *   <li>{@link AGSN.impl.ModuleElementImpl#getAttachment <em>Attachment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleElementImpl extends BasicNodeImpl implements ModuleElement {
	...
	protected EClass eStaticClass() {
		return AGSNPackage.Literals.MODULE_ELEMENT;
	}
	...
	public void setAttachment(String newAttachment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.MODULE_ELEMENT__ATTACHMENT, oldAttachment, attachment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AGSNPackage.MODULE_ELEMENT__ATTACHMENT:
