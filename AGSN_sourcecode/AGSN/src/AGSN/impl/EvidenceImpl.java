 ...
 * </p>
 * <ul>
 *   <li>{@link AGSN.impl.EvidenceImpl#getAttachment <em>Attachment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvidenceImpl extends BasicNodeImpl implements Evidence {
	...
	protected EClass eStaticClass() {
		return AGSNPackage.Literals.EVIDENCE;
	}
	...
	public void setAttachment(String newAttachment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.EVIDENCE__ATTACHMENT, oldAttachment, attachment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AGSNPackage.EVIDENCE__ATTACHMENT:
