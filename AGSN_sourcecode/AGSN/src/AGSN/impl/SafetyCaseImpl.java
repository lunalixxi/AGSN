 ...
 * </p>
 * <ul>
 *   <li>{@link AGSN.impl.SafetyCaseImpl#getRootBasicNode <em>Root Basic Node</em>}</li>
 *   <li>{@link AGSN.impl.SafetyCaseImpl#getRootBasicLink <em>Root Basic Link</em>}</li>
 *   <li>{@link AGSN.impl.SafetyCaseImpl#getRootCommendation <em>Root Commendation</em>}</li>
 *   <li>{@link AGSN.impl.SafetyCaseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link AGSN.impl.SafetyCaseImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SafetyCaseImpl extends EObjectImpl implements SafetyCase {
	...
	protected EClass eStaticClass() {
		return AGSNPackage.Literals.SAFETY_CASE;
	}
	...
	public EList<BasicNode> getRootBasicNode() {
		if (rootBasicNode == null) {
			rootBasicNode = new EObjectContainmentEList<BasicNode>(BasicNode.class, this, AGSNPackage.SAFETY_CASE__ROOT_BASIC_NODE);
		}
	...
	public EList<BasicLink> getRootBasicLink() {
		if (rootBasicLink == null) {
			rootBasicLink = new EObjectContainmentEList<BasicLink>(BasicLink.class, this, AGSNPackage.SAFETY_CASE__ROOT_BASIC_LINK);
		}
	...
	public EList<Recommendation> getRootCommendation() {
		if (rootCommendation == null) {
			rootCommendation = new EObjectContainmentEList<Recommendation>(Recommendation.class, this, AGSNPackage.SAFETY_CASE__ROOT_COMMENDATION);
		}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.SAFETY_CASE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.SAFETY_CASE__ID, oldId, id));
	}
