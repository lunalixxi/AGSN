 ...
 * </p>
 * <ul>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getId <em>Id</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getAssessstatus <em>Assessstatus</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getHasComment <em>Has Comment</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getQualityLevel <em>Quality Level</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getConfidencePercentage <em>Confidence Percentage</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link AGSN.impl.BasicNodeImpl#getBeliefDegree <em>Belief Degree</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BasicNodeImpl extends EObjectImpl implements BasicNode {
	...
	protected EClass eStaticClass() {
		return AGSNPackage.Literals.BASIC_NODE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__NAME, oldName, name));
	}
	...
	public void setAssessstatus(AssessStatus newAssessstatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__ASSESSSTATUS, oldAssessstatus, assessstatus));
	}
	...
	public Recommendation getHasComment() {
		if (hasComment != null && hasComment.eIsProxy()) {
			...
			if (hasComment != oldHasComment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AGSNPackage.BASIC_NODE__HAS_COMMENT, oldHasComment, hasComment));
			}
		}
		return hasComment;
	}
	...
	public void setHasComment(Recommendation newHasComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__HAS_COMMENT, oldHasComment, hasComment));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setQualityLevel(Level newQualityLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__QUALITY_LEVEL, oldQualityLevel, qualityLevel));
	}
	...
	public void setConfidencePercentage(Integer newConfidencePercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__CONFIDENCE_PERCENTAGE, oldConfidencePercentage, confidencePercentage));
	}
	...
	public void setWeight(double newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__WEIGHT, oldWeight, weight));
	}
	...
	public void setBeliefDegree(double[] newBeliefDegree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AGSNPackage.BASIC_NODE__BELIEF_DEGREE, oldBeliefDegree, beliefDegree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AGSNPackage.BASIC_NODE__ID:
				return getId();
			case AGSNPackage.BASIC_NODE__NAME:
				return getName();
			case AGSNPackage.BASIC_NODE__ASSESSSTATUS:
				return getAssessstatus();
			case AGSNPackage.BASIC_NODE__HAS_COMMENT:
				if (resolve) return getHasComment();
				return basicGetHasComment();
			case AGSNPackage.BASIC_NODE__DESCRIPTION:
				return getDescription();
			case AGSNPackage.BASIC_NODE__QUALITY_LEVEL:
				return getQualityLevel();
			case AGSNPackage.BASIC_NODE__CONFIDENCE_PERCENTAGE:
				return getConfidencePercentage();
			case AGSNPackage.BASIC_NODE__WEIGHT:
				return getWeight();
			case AGSNPackage.BASIC_NODE__BELIEF_DEGREE:
