...
public enum MessageTypeImpl implements IMessageType {
    ...
    /**
     * Failed to open a report.
     */
    OPEN_REPORT_INVALID_FILE(MessageLevel.ERROR, FunctionTypeImpl.OPEN_REPORT), 
    /**
     * A critical error while opening a report.
     */
    OPEN_REPORT_CRITICAL_FAILED(MessageLevel.CRITICAL, FunctionTypeImpl.OPEN_REPORT);
