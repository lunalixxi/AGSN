 ...
 */
package AGSN.diagram.common.command;
    ...
    protected CommandResult doExecuteWithResult(
        ...
        switch (nodeType) {
            ...
            case CONTEXT:
                ...
                break;
            case EVIDENCE:
                if (attrributeTypeSet.contains(AttributeType.ATTACHMENT)) {
                    Evidence evidence = (Evidence) basicNode;
                    evidence.setAttachment((String) attributeMap
                            .get(AttributeType.ATTACHMENT));
                }
                break;
            case ADDITIONALELEMENT:
            	if (attrributeTypeSet.contains(AttributeType.ATTACHMENT)) {
            		AdditionalElement dcasenode = (AdditionalElement) basicNode;
                    dcasenode.setAttachment((String) attributeMap
                            .get(AttributeType.ATTACHMENT));
                }
                break;
            case MODULE:
            	if (attrributeTypeSet.contains(AttributeType.ATTACHMENT)) {
            		Module module = (Module) basicNode;
            		module.setAttachment((String) attributeMap
                            .get(AttributeType.ATTACHMENT));
                }
                break;
            case CONTRACT:
            	if (attrributeTypeSet.contains(AttributeType.ATTACHMENT)) {
            		Contract contract = (Contract) basicNode;
            		contract.setAttachment((String) attributeMap
                            .get(AttributeType.ATTACHMENT));
                }
                break;
            default:
        ...
        for (Map.Entry<AttributeType, Object> attribute : attributeMap
            ...
            switch (attribute.getKey()) {
                case NAME:
                    ...
                    break;
                case DESC:
                    basicNode.setDescription((String) value);
                    break;
                /*case ATTACHMENT:
                    basicNode.setAttachment((String) value);
                    break;*/
                case ASSESSMENTSTATUS:
                    basicNode.setAssessstatus((AssessStatus) value);
                    break;
                /*case FLAG:
