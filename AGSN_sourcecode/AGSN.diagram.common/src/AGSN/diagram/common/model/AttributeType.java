...
import AGSN.diagram.common.validator.AttributeRuleType;
...
public enum AttributeType {
	...
	ASSESSMENTSTATUS(AttributeRuleType.NO_RULE),
	CONFIDENCE(AttributeRuleType.NO_RULE),
    QUALITYLEVEL(AttributeRuleType.NO_RULE);
