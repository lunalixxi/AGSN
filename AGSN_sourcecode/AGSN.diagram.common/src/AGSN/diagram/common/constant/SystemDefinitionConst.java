...
public final class SystemDefinitionConst {
    ...
    /**
     * The string that represents the type name of the DCase node.
     */
    public static final String ADDITIONALNODE_NAME = "AdditionalElement"; //$NON-NLS-1$
     ...
     */
    public static final String ASSUMPTION_NAME = "Assumption"; //$NON-NLS-1$

    /**
     * The string that represents the type name of the Module node.
     */
    public static final String MODULE_NAME = "Module"; //$NON-NLS-1$

    /**
     * The string that represents the type name of the Contract node.
     */
    public static final String CONTRACT_NAME = "Contract"; //$NON-NLS-1$
     ...
     * The string that represents the type name of the Argument.
     */
    public static final String SAFETYCASE_NAME = "SafetyCase";  //$NON-NLS-1$
