 ...
 * @generated
 */
public class RequiredActionItemSemanticEditPolicy extends AGSNBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public RequiredActionItemSemanticEditPolicy() {
		super(AGSNElementTypes.RequiredAction_2014);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (AGSNVisualIDRegistry.getVisualID(incomingLink) == BasicNodeHasCommentEditPart.VISUAL_ID) {
