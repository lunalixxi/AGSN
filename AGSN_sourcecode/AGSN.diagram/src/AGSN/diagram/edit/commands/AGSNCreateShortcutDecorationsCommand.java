 ...
 * @generated
 */
public class AGSNCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public AGSNCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put("modelID", SafetyCaseEditPart.MODEL_ID); //$NON-NLS-1$
