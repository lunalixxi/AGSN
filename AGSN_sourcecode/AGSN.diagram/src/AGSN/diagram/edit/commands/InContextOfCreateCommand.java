...
public class InContextOfCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return AGSNBaseItemSemanticEditPolicy.getLinkConstraints().canCreateInContextOf_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		InContextOf newElement = AGSNFactory.eINSTANCE.createInContextOf();
