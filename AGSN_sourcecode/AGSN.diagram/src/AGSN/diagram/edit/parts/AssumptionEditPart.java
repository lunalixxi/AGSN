...
import AGSN.diagram.edit.policies.AssumptionItemSemanticEditPolicy;
...
public class AssumptionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AssumptionNameEditPart) {
			((AssumptionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssumptionLabelFigure());
			return true;
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AGSNVisualIDRegistry.getType(AssumptionNameEditPart.VISUAL_ID));
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttributeImpl
					&& event.getFeatureID(Assumption.class) == AGSNPackage.ASSUMPTION__ASSESSSTATUS) {
	...
	public class AssumptionFigure extends GSNAssumption {
		...
		public void updateBGColor() {
			Assumption assumption = (Assumption) ((Node) AssumptionEditPart.this.getModel()).getElement();

			switch (assumption.getAssessstatus()) {
			case NOT_REVIEWED:
