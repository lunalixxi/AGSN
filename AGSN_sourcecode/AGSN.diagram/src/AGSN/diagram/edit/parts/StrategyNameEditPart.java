 ...
 * @generated
 */
public class StrategyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Strategy_2008, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.StrategyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
