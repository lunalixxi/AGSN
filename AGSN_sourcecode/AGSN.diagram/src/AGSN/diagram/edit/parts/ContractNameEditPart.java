 ...
 * @generated
 */
public class ContractNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContractNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Contract_2020, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ContractNameEditPart.VISUAL_ID));
		}
		return parser;
	}
