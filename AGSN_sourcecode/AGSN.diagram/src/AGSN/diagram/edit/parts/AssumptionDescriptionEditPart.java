 ...
 * @generated
 */
public class AssumptionDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssumptionDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Assumption_2012, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.AssumptionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
