 ...
 * @generated
 */
public class ContextDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContextDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Context_2010, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ContextDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
