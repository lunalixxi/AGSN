 ...
 * @generated
 */
public class QuestionDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuestionDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Question_2016, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.QuestionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
