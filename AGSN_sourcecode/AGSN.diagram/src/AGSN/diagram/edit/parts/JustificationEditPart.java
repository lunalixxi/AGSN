...
import AGSN.diagram.edit.policies.JustificationItemSemanticEditPolicy;
import AGSN.diagram.part.AGSNVisualIDRegistry;
import gsnfigures.GSNJustification;
...
public class JustificationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof JustificationNameEditPart) {
			((JustificationNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureJustificationLabelFigure());
			return true;
		}
		if (childEditPart instanceof JustificationDescriptionEditPart) {
			((JustificationDescriptionEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AGSNVisualIDRegistry.getType(JustificationNameEditPart.VISUAL_ID));
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttributeImpl
					&& event.getFeatureID(Justification.class) == AGSNPackage.JUSTIFICATION__ASSESSSTATUS) {
	 ...
	 * @generated
	 */
	public class JustificationFigure extends GSNJustification {
		...
		public void updateBGColor() {
			Justification justification = (Justification) ((Node) JustificationEditPart.this.getModel()).getElement();

			switch (justification.getAssessstatus()) {
			case NOT_REVIEWED:
