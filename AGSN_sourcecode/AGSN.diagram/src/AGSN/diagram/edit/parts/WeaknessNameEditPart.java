 ...
 * @generated
 */
public class WeaknessNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public WeaknessNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Weakness_2015, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.WeaknessNameEditPart.VISUAL_ID));
		}
		return parser;
	}
