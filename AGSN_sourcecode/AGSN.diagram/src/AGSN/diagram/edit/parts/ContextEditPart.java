...
import AGSN.diagram.edit.policies.ContextItemSemanticEditPolicy;
import AGSN.diagram.part.AGSNVisualIDRegistry;
import gsnfigures.GSNContext;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContextNameEditPart) {
			((ContextNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureContextLabelFigure());
			return true;
		}
		if (childEditPart instanceof ContextDescriptionEditPart) {
			((ContextDescriptionEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AGSNVisualIDRegistry.getType(ContextNameEditPart.VISUAL_ID));
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttributeImpl
					&& event.getFeatureID(Context.class) == AGSNPackage.CONTEXT__ASSESSSTATUS) {
	 ...
	 * @generated
	 */
	public class ContextFigure extends GSNContext {
		...
		public void updateBGColor() {
			Context context = (Context) ((Node) ContextEditPart.this.getModel()).getElement();

			switch (context.getAssessstatus()) {
			case NOT_REVIEWED:
