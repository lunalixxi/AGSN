 ...
 * @generated
 */
public class ModuleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModuleNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Module_2019, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ModuleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
