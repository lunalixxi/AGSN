 ...
 * @generated
 */
public class ContractDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContractDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Contract_2020, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ContractDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
