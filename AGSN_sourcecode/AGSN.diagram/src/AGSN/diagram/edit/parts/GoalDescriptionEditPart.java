 ...
 * @generated
 */
public class GoalDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GoalDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Goal_2007, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.GoalDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
