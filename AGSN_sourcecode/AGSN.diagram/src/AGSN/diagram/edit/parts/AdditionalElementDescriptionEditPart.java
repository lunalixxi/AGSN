 ...
 * @generated
 */
public class AdditionalElementDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdditionalElementDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.AdditionalElement_2018, getParserElement(),
					AGSNVisualIDRegistry
							.getType(AGSN.diagram.edit.parts.AdditionalElementDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
