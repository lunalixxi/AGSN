 ...
 * @generated
 */
public class StrengthDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StrengthDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Strength_2013, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.StrengthDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
