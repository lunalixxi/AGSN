 ...
 * @generated
 */
public class EvidenceDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EvidenceDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Evidence_2009, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.EvidenceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
