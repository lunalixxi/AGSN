 ...
 * @generated
 */
public class JustificationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Justification_2011, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.JustificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
