...
import AGSN.diagram.edit.policies.AGSNTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AdditionalElementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdditionalElementNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new AGSNTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return AGSNElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.AdditionalElement_2018, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.AdditionalElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, AGSNEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
