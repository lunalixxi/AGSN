 ...
 * @generated
 */
public class RequiredActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RequiredActionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.RequiredAction_2014, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.RequiredActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
