 ...
 * @generated
 */
public class QuestionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuestionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Question_2016, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.QuestionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
