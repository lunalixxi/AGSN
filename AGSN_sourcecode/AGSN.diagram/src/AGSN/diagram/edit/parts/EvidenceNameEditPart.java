 ...
 * @generated
 */
public class EvidenceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Evidence_2009, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.EvidenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
