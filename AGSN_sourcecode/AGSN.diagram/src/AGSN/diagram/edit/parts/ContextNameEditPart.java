 ...
 * @generated
 */
public class ContextNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Context_2010, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ContextNameEditPart.VISUAL_ID));
		}
		return parser;
	}
