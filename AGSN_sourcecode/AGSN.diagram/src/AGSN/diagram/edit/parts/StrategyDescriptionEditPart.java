 ...
 * @generated
 */
public class StrategyDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StrategyDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Strategy_2008, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.StrategyDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
