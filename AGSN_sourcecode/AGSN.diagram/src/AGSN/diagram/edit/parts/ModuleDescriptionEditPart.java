 ...
 * @generated
 */
public class ModuleDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModuleDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Module_2019, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.ModuleDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
