 ...
 * @generated
 */
public class StrengthNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StrengthNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Strength_2013, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.StrengthNameEditPart.VISUAL_ID));
		}
		return parser;
	}
