 ...
 * @generated
 */
public class JustificationDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public JustificationDescriptionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Justification_2011, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.JustificationDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
