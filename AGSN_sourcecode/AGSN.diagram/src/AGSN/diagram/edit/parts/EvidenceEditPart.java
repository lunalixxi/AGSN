...
import AGSN.diagram.edit.policies.EvidenceItemSemanticEditPolicy;
...
public class EvidenceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EvidenceItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EvidenceNameEditPart) {
			((EvidenceNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEvidenceLabelFigure());
			return true;
		}
		if (childEditPart instanceof EvidenceDescriptionEditPart) {
			((EvidenceDescriptionEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AGSNVisualIDRegistry.getType(EvidenceNameEditPart.VISUAL_ID));
	}
	...
	*/
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() == getModel()
			...
			if (event.getFeature() instanceof EAttributeImpl
					&& event.getFeatureID(Evidence.class) == AGSNPackage.EVIDENCE__ASSESSSTATUS) {
	 ...
	 * @generated
	 */
	public class EvidenceFigure extends GSNSolution {
		...
		public void updateBGColor() {
			Evidence evidence = (Evidence) ((Node) EvidenceEditPart.this.getModel()).getElement();

			switch (evidence.getAssessstatus()) {
			case NOT_REVIEWED:
