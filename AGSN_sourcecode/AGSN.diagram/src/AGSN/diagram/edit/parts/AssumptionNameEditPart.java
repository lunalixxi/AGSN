 ...
 * @generated
 */
public class AssumptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssumptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.Assumption_2012, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.AssumptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
