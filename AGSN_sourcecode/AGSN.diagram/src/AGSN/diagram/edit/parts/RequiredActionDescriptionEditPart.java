 ...
 * @generated
 */
public class RequiredActionDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RequiredActionDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AGSNParserProvider.getParser(AGSNElementTypes.RequiredAction_2014, getParserElement(),
					AGSNVisualIDRegistry.getType(AGSN.diagram.edit.parts.RequiredActionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
